...
In this chapter, we'll focus on some simple implementations of loops, focusing separately on self-written loops and **vectorized loops** in R. We'll also take a look at a couple of looping procedures in SAS.
