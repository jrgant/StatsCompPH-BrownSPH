...
Data comes in many formats. Some formats are universal and easily imported into most statistical programs, while others are proprietary and tailored to a specific program.
...
Notice that the variable names from the SAS import are slightly different because periods are not permissible characters in SAS variable names.
