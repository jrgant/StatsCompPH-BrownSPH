...
If you aren't yet familiar with RStudio, take a minute to [familiarize yourself with the interface](https://www.r-bloggers.com/a-tour-of-rstudio/). You should be comfortable with each pane and its functions, as well as understand the difference between writing code in R scripts versus entering code into the console.
...
<dev-note>Should also provide a glossary or quick tutorial on getting acquainted with the interfaces. For instance, what's a console, source file, etc.</dev-note>
