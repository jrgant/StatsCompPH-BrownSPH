...
Unfortunately, Mac users will need to use a server-based service called SAS University, as local downloads of SAS 9.4 and SAS Enterprise Guide **are not** available for Mac.
