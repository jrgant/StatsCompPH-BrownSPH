...
tibble::tribble(
  ...
  "numeric",
  "A numeric value, which might include floats, doubles, or integers",
  "400, 3.1415, 0.07",
...
To conduct a statistical analysis, usually we will need to store values in various types of _objects_. These objects can be tailored toward specific data type or may enable the user to store multiple data types.
...
tibble::tribble(
  ...
  "data.frame",
  "A special type of list capable of storing mixed data types in rectangular format. In other words, data.frames are what we probably think of when imagining a dataset from a trial or observational study. We will have a look at some subtypes of data.frames such as data.tables and tibbles later in the guide."
