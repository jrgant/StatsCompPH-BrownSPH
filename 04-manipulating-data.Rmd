...
Data are a [rectangular data format](https://www.oreilly.com/library/view/practical-statistics-for/9781491952955/ch01.html), that is, a format which generally stores data with a series of labeled columns (variables) and observations (rows).
